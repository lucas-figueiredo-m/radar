...
Client SDK for [Radar](https://github.com/lucas-figueiredo-m/radar) - Unified DevTools for React Native.
...
[MIT](https://github.com/lucas-figueiredo-m/radar/blob/main/LICENSE)
