...
```bash
git clone https://github.com/lucas-figueiredo-m/radar.git
cd radar
```
...
Use [GitHub Issues](https://github.com/lucas-figueiredo-m/radar/issues) to report bugs or request features. Include:
